...
<title>Özür Dilerim Essegimm</title>
<style>
  body {
    margin:0; padding:0;
    height:100vh;
  ...
  #no {
    ...
    left: 60%;
    top: 60%;
    position: absolute; /* Hareket için absolute */
  }
  .heart {
    position: fixed;
    font-size: 20px;
